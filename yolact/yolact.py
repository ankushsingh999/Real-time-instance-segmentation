    ...
    def __init__(self, in_channels, out_channels=1024, aspect_ratios=[[1]], scales=[1], parent=None, index=0):
        ...
        if parent is None:
            if cfg.extra_head_net is None:
                ...
                self.upfeature, out_channels = func.make_net(in_channels, cfg.extra_head_net)
...
class FastMaskIoUNet(ScriptModuleWrapper):
    ...
    def __init__(self):
        ...
        self.maskiou_net, _ = func.make_net(input_channels, cfg.maskiou_net + last_layer, include_last_relu=True)
...
class Yolact(nn.Module):
    ...
    def __init__(self):
        ...
        if cfg.mask_type == mask_type.direct:
            ...
            self.proto_net, cfg.mask_dim = func.make_net(in_channels, cfg.mask_proto_net, include_last_relu=False)
